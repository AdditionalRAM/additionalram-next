  ...
  return (
    <main className={styles.gradientBackground} style={{overflow: "hidden"}}>
      ...
      <section id="game-development" className={styles.spaceTop}>
        ...
        <RotatingIcons elements={gameStackIcons} centerSelector="#game-development-orbit" radiusVW={16} smallScreenRadiusVW={40} speed={10} iconClass="gameDevOrbit" uniqueID="gamedev" />
      ...
      <section id="web-development">
        ...
        <RotatingIcons elements={webStackIcons} centerSelector="#web-development-orbit" radiusVW={16} smallScreenRadiusVW={40}  speed={10} iconClass="webDevOrbit" uniqueID="webdev" />
